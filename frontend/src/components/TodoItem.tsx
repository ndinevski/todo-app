...
export const TodoItem: React.FC<TodoItemProps> = ({
  ...
  return (
    <div
      className={`flex items-center justify-between p-4 bg-gray-800 rounded-lg shadow-lg border border-gray-700 hover:border-gray-600 transition-all ${
    ...
    ${
      todo.completed
        ...
        >
          {todo.completed ? <Check size={16} className="text-white" /> : null}
        </button>
